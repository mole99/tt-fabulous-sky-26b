module tiny_fabric_8x5
    ...
    (
        ...
        input  Tile_X7Y1_A_OUT_top, //EXTERNAL
        output  Tile_X7Y1_A_IN_top, //EXTERNAL
        output  Tile_X7Y1_A_EN_top, //EXTERNAL
        input  Tile_X7Y1_B_OUT_top, //EXTERNAL
        output  Tile_X7Y1_B_IN_top, //EXTERNAL
        output  Tile_X7Y1_B_EN_top, //EXTERNAL
        input  Tile_X7Y1_C_OUT_top, //EXTERNAL
        output  Tile_X7Y1_C_IN_top, //EXTERNAL
        output  Tile_X7Y1_C_EN_top, //EXTERNAL
        input  Tile_X7Y1_D_OUT_top, //EXTERNAL
        output  Tile_X7Y1_D_IN_top, //EXTERNAL
        output  Tile_X7Y1_D_EN_top, //EXTERNAL
        ...
        input  Tile_X7Y3_A_OUT_top, //EXTERNAL
        output  Tile_X7Y3_A_IN_top, //EXTERNAL
        output  Tile_X7Y3_A_EN_top, //EXTERNAL
        input  Tile_X7Y3_B_OUT_top, //EXTERNAL
        output  Tile_X7Y3_B_IN_top, //EXTERNAL
        output  Tile_X7Y3_B_EN_top, //EXTERNAL
        input  Tile_X7Y3_C_OUT_top, //EXTERNAL
        output  Tile_X7Y3_C_IN_top, //EXTERNAL
        output  Tile_X7Y3_C_EN_top, //EXTERNAL
        input  Tile_X7Y3_D_OUT_top, //EXTERNAL
        output  Tile_X7Y3_D_IN_top, //EXTERNAL
        output  Tile_X7Y3_D_EN_top, //EXTERNAL
...
`endif
    ...
    .A_OUT_top(Tile_X7Y1_A_OUT_top),
    .A_IN_top(Tile_X7Y1_A_IN_top),
    .A_EN_top(Tile_X7Y1_A_EN_top),
    .B_OUT_top(Tile_X7Y1_B_OUT_top),
    .B_IN_top(Tile_X7Y1_B_IN_top),
    .B_EN_top(Tile_X7Y1_B_EN_top),
    .C_OUT_top(Tile_X7Y1_C_OUT_top),
    .C_IN_top(Tile_X7Y1_C_IN_top),
    .C_EN_top(Tile_X7Y1_C_EN_top),
    .D_OUT_top(Tile_X7Y1_D_OUT_top),
    .D_IN_top(Tile_X7Y1_D_IN_top),
    .D_EN_top(Tile_X7Y1_D_EN_top),
...
`endif
    ...
    .A_OUT_top(Tile_X7Y3_A_OUT_top),
    .A_IN_top(Tile_X7Y3_A_IN_top),
    .A_EN_top(Tile_X7Y3_A_EN_top),
    .B_OUT_top(Tile_X7Y3_B_OUT_top),
    .B_IN_top(Tile_X7Y3_B_IN_top),
    .B_EN_top(Tile_X7Y3_B_EN_top),
    .C_OUT_top(Tile_X7Y3_C_OUT_top),
    .C_IN_top(Tile_X7Y3_C_IN_top),
    .C_EN_top(Tile_X7Y3_C_EN_top),
    .D_OUT_top(Tile_X7Y3_D_OUT_top),
    .D_IN_top(Tile_X7Y3_D_IN_top),
    .D_EN_top(Tile_X7Y3_D_EN_top),
